.class public final Lcom/esri/arcgisruntime/internal/io/handler/request/e;
...
.method public constructor <init>(Lcom/esri/arcgisruntime/internal/jni/CoreRequest;Lcom/esri/arcgisruntime/io/RemoteResource;Ljava/lang/String;Ljava/util/Map;Z)V
    ...
    iput-object p4, p0, Lcom/esri/arcgisruntime/internal/io/handler/request/e;->mParams:Ljava/util/Map;

    iput-boolean p5, p0, Lcom/esri/arcgisruntime/internal/io/handler/request/e;->mForcePost:Z

    return-void
.end method

.method public static a(Lcom/esri/arcgisruntime/concurrent/ListenableFuture;Lcom/esri/arcgisruntime/internal/jni/CoreRequest;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    new-instance v0, Lcom/esri/arcgisruntime/internal/io/handler/request/e$a;

    invoke-direct {v0, p0, p1}, Lcom/esri/arcgisruntime/internal/io/handler/request/e$a;-><init>(Lcom/esri/arcgisruntime/concurrent/ListenableFuture;Lcom/esri/arcgisruntime/internal/jni/CoreRequest;)V

    invoke-interface {p0, v0}, Lcom/esri/arcgisruntime/concurrent/ListenableFuture;->addDoneListener(Ljava/lang/Runnable;)V
...
.method public bridge synthetic d()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lcom/esri/arcgisruntime/internal/io/handler/request/e;->x()Lcom/esri/arcgisruntime/internal/io/handler/request/f;
...
.method protected j()Lcom/esri/arcgisruntime/internal/io/handler/f;
    ...
    iget-object v0, p0, Lcom/esri/arcgisruntime/internal/io/handler/request/e;->mParams:Ljava/util/Map;

    invoke-static {v0}, Lcom/esri/arcgisruntime/internal/io/handler/request/c;->a(Ljava/util/Map;)Ljava/util/List;

    move-result-object v0

    iget-boolean v1, p0, Lcom/esri/arcgisruntime/internal/io/handler/request/e;->mForcePost:Z
