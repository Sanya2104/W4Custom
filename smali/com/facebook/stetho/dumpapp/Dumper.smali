...
.field private final mParser:Lng/c;
...
.method public constructor <init>(Ljava/lang/Iterable;)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/facebook/stetho/dumpapp/Dumper;-><init>(Ljava/lang/Iterable;Lng/c;)V

    return-void
.end method

.method public constructor <init>(Ljava/lang/Iterable;Lng/c;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p2, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mParser:Lng/c;
...
.method private doDump(Ljava/io/InputStream;Ljava/io/PrintStream;Ljava/io/PrintStream;[Ljava/lang/String;)I
    ...
    iget-object v0, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mParser:Lng/c;

    iget-object v1, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mGlobalOptions:Lcom/facebook/stetho/dumpapp/GlobalOptions;

    iget-object v1, v1, Lcom/facebook/stetho/dumpapp/GlobalOptions;->options:Lng/l;

    const/4 v2, 0x1

    invoke-interface {v0, v1, p4, v2}, Lng/c;->a(Lng/l;[Ljava/lang/String;Z)Lng/b;

    move-result-object p4

    iget-object v0, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mGlobalOptions:Lcom/facebook/stetho/dumpapp/GlobalOptions;

    iget-object v0, v0, Lcom/facebook/stetho/dumpapp/GlobalOptions;->optionHelp:Lng/i;

    invoke-virtual {v0}, Lng/i;->h()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p4, v0}, Lng/b;->d(Ljava/lang/String;)Z
    ...
    iget-object v0, v0, Lcom/facebook/stetho/dumpapp/GlobalOptions;->optionListPlugins:Lng/i;
    ...
    :cond_1
    invoke-virtual {p4}, Lng/b;->c()Ljava/util/List;
    ...
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/facebook/stetho/dumpapp/Dumper;->dumpPluginOutput(Ljava/io/InputStream;Ljava/io/PrintStream;Ljava/io/PrintStream;Lng/b;)V
...
.method private dumpPluginOutput(Ljava/io/InputStream;Ljava/io/PrintStream;Ljava/io/PrintStream;Lng/b;)V
    .locals 7
    ...
    iget-object v4, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mParser:Lng/c;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/facebook/stetho/dumpapp/DumperContext;-><init>(Ljava/io/InputStream;Ljava/io/PrintStream;Ljava/io/PrintStream;Lng/c;Ljava/util/List;)V
...
.method private dumpUsage(Ljava/io/PrintStream;)V
    ...
    :try_start_0
    invoke-virtual {v0}, Lng/f;->f()I

    move-result v2

    iget-object p1, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mGlobalOptions:Lcom/facebook/stetho/dumpapp/GlobalOptions;

    iget-object v3, p1, Lcom/facebook/stetho/dumpapp/GlobalOptions;->options:Lng/l;

    invoke-virtual {v0}, Lng/f;->d()I

    move-result v4

    invoke-virtual {v0}, Lng/f;->c()I

    move-result v5

    move-object v1, v6

    invoke-virtual/range {v0 .. v5}, Lng/f;->g(Ljava/io/PrintWriter;ILng/l;II)V
    :try_end_0
...
.method public dump(Ljava/io/InputStream;Ljava/io/PrintStream;Ljava/io/PrintStream;[Ljava/lang/String;)I
    ...
    move-result p1
    :try_end_0
    .catch Lng/m; {:try_start_0 .. :try_end_0} :catch_3
