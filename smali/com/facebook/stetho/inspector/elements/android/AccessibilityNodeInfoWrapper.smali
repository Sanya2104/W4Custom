...
.method public static createNodeInfoFromView(Landroid/view/View;)Lo0/j;
    .locals 1
    ...
    invoke-static {p0, v0}, Ln0/f0;->a0(Landroid/view/View;Lo0/j;)V
...
.method public static getActions(Landroid/view/View;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/facebook/stetho/inspector/elements/android/AccessibilityNodeInfoWrapper;->createNodeInfoFromView(Landroid/view/View;)Lo0/j;
    ...
    invoke-virtual {v2}, Lo0/j$a;->c()Ljava/lang/CharSequence;
...
.method public static getDescription(Landroid/view/View;)Ljava/lang/CharSequence;
    ...
    invoke-static {v5, v6}, Ln0/f0;->a0(Landroid/view/View;Lo0/j;)V

    invoke-static {v6, v5}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->isSpeakingNode(Lo0/j;Landroid/view/View;)Z

    move-result v7

    if-eqz v7, :cond_4

    invoke-static {v6, v5}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->isAccessibilityFocusable(Lo0/j;Landroid/view/View;)Z
...
.method public static getFocusableReasons(Landroid/view/View;)Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {v0}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->hasText(Lo0/j;)Z

    move-result v1

    invoke-virtual {v0}, Lo0/j;->C()Z

    move-result v2

    invoke-static {v0, p0}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->hasNonActionableSpeakingDescendants(Lo0/j;Landroid/view/View;)Z

    move-result v3

    invoke-static {v0}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->isActionableForAccessibility(Lo0/j;)Z
    ...
    :cond_3
    :try_start_4
    invoke-static {v0, p0}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->isTopLevelScrollItem(Lo0/j;Landroid/view/View;)Z
...
.method public static getIgnored(Landroid/view/View;)Z
    ...
    invoke-static {v3}, Ln0/f0;->x(Landroid/view/View;)I
    ...
    :cond_3
    :try_start_1
    invoke-static {v0, p0}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->isAccessibilityFocusable(Lo0/j;Landroid/view/View;)Z
    ...
    :cond_4
    :try_start_2
    invoke-static {v0, p0}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->isSpeakingNode(Lo0/j;Landroid/view/View;)Z
    ...
    :cond_6
    :try_start_3
    invoke-static {v0, p0}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->hasFocusableAncestor(Lo0/j;Landroid/view/View;)Z
...
.method public static getIgnoredReasons(Landroid/view/View;)Ljava/lang/String;
    ...
    invoke-static {v2}, Ln0/f0;->x(Landroid/view/View;)I
