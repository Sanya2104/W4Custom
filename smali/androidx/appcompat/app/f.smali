...
.method private a(Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p1}, Ln0/f0;->N(Landroid/view/View;)Z
...
.method protected o(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/j0;
    .locals 1
...
.method final q(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;ZZZZ)Landroid/view/View;
    ...
    invoke-static {p1}, Landroidx/appcompat/widget/g1;->b(Landroid/content/Context;)Landroid/content/Context;
    ...
    :pswitch_2
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/f;->d(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/f;
    ...
    :pswitch_4
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/f;->h(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/m;
    ...
    :pswitch_5
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/f;->o(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/j0;
    ...
    :pswitch_6
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/f;->j(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/q;
    ...
    :pswitch_7
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/f;->m(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/w;
    ...
    :pswitch_8
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/f;->l(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/u;
    ...
    :pswitch_9
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/f;->g(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/k;
    ...
    :pswitch_a
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/f;->n(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/f0;
    ...
    :pswitch_b
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/f;->i(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/n;
    ...
    :pswitch_c
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/f;->e(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/g;
    ...
    :pswitch_d
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/f;->k(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/r;
