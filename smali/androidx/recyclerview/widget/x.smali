...
.method private k(Landroid/view/View;Landroidx/recyclerview/widget/w;)I
    .locals 1
    ...
    invoke-virtual {p2}, Landroidx/recyclerview/widget/w;->m()I
...
.method private l(Landroidx/recyclerview/widget/RecyclerView$p;Landroidx/recyclerview/widget/w;)Landroid/view/View;
    .locals 8
...
.method private m(Landroidx/recyclerview/widget/RecyclerView$p;)Landroidx/recyclerview/widget/w;
    .locals 1
    ...
    iget-object v0, v0, Landroidx/recyclerview/widget/w;->a:Landroidx/recyclerview/widget/RecyclerView$p;

    if-eq v0, p1, :cond_1

    :cond_0
    invoke-static {p1}, Landroidx/recyclerview/widget/w;->a(Landroidx/recyclerview/widget/RecyclerView$p;)Landroidx/recyclerview/widget/w;
...
.method private n(Landroidx/recyclerview/widget/RecyclerView$p;)Landroidx/recyclerview/widget/w;
    .locals 1
    ...
    invoke-direct {p0, p1}, Landroidx/recyclerview/widget/x;->o(Landroidx/recyclerview/widget/RecyclerView$p;)Landroidx/recyclerview/widget/w;
    ...
    invoke-direct {p0, p1}, Landroidx/recyclerview/widget/x;->m(Landroidx/recyclerview/widget/RecyclerView$p;)Landroidx/recyclerview/widget/w;
...
.method private o(Landroidx/recyclerview/widget/RecyclerView$p;)Landroidx/recyclerview/widget/w;
    .locals 1
    ...
    :cond_0
    invoke-static {p1}, Landroidx/recyclerview/widget/w;->c(Landroidx/recyclerview/widget/RecyclerView$p;)Landroidx/recyclerview/widget/w;

    move-result-object p1

    iput-object p1, p0, Landroidx/recyclerview/widget/x;->d:Landroidx/recyclerview/widget/w;
...
.method public c(Landroidx/recyclerview/widget/RecyclerView$p;Landroid/view/View;)[I
    ...
    invoke-direct {p0, p2, v1}, Landroidx/recyclerview/widget/x;->k(Landroid/view/View;Landroidx/recyclerview/widget/w;)I
    ...
    invoke-direct {p0, p2, p1}, Landroidx/recyclerview/widget/x;->k(Landroid/view/View;Landroidx/recyclerview/widget/w;)I
...
.method public f(Landroidx/recyclerview/widget/RecyclerView$p;)Landroid/view/View;
    ...
    invoke-direct {p0, p1, v0}, Landroidx/recyclerview/widget/x;->l(Landroidx/recyclerview/widget/RecyclerView$p;Landroidx/recyclerview/widget/w;)Landroid/view/View;
...
.method public g(Landroidx/recyclerview/widget/RecyclerView$p;II)I
    ...
    :cond_0
    invoke-direct {p0, p1}, Landroidx/recyclerview/widget/x;->n(Landroidx/recyclerview/widget/RecyclerView$p;)Landroidx/recyclerview/widget/w;
    ...
    :cond_2
    invoke-direct {p0, v9, v2}, Landroidx/recyclerview/widget/x;->k(Landroid/view/View;Landroidx/recyclerview/widget/w;)I
    ...
    :cond_5
    invoke-direct {p0, p1, p2, p3}, Landroidx/recyclerview/widget/x;->p(Landroidx/recyclerview/widget/RecyclerView$p;II)Z
    ...
    invoke-direct {p0, p1}, Landroidx/recyclerview/widget/x;->q(Landroidx/recyclerview/widget/RecyclerView$p;)Z
