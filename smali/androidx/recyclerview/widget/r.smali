...
.method private A()F
    ...
    invoke-virtual {p0, v0}, Landroidx/recyclerview/widget/r;->v(Landroid/util/DisplayMetrics;)F
...
.method protected C(Landroidx/recyclerview/widget/RecyclerView$a0$a;)V
    ...
    iput-object v0, p0, Landroidx/recyclerview/widget/r;->k:Landroid/graphics/PointF;
    ...
    iput v1, p0, Landroidx/recyclerview/widget/r;->o:I
    ...
    invoke-virtual {p0, v0}, Landroidx/recyclerview/widget/r;->x(I)I
    ...
    iget-object v2, p0, Landroidx/recyclerview/widget/r;->i:Landroid/view/animation/LinearInterpolator;
...
.method protected l(IILandroidx/recyclerview/widget/RecyclerView$b0;Landroidx/recyclerview/widget/RecyclerView$a0$a;)V
    ...
    :cond_0
    iget p3, p0, Landroidx/recyclerview/widget/r;->o:I

    invoke-direct {p0, p3, p1}, Landroidx/recyclerview/widget/r;->y(II)I

    move-result p1

    iput p1, p0, Landroidx/recyclerview/widget/r;->o:I

    iget p1, p0, Landroidx/recyclerview/widget/r;->p:I

    invoke-direct {p0, p1, p2}, Landroidx/recyclerview/widget/r;->y(II)I
    ...
    invoke-virtual {p0, p4}, Landroidx/recyclerview/widget/r;->C(Landroidx/recyclerview/widget/RecyclerView$a0$a;)V
...
.method protected o(Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView$b0;Landroidx/recyclerview/widget/RecyclerView$a0$a;)V
    ...
    invoke-virtual {p0}, Landroidx/recyclerview/widget/r;->z()I

    move-result p2

    invoke-virtual {p0, p1, p2}, Landroidx/recyclerview/widget/r;->t(Landroid/view/View;I)I

    move-result p2

    invoke-virtual {p0}, Landroidx/recyclerview/widget/r;->B()I

    move-result v0

    invoke-virtual {p0, p1, v0}, Landroidx/recyclerview/widget/r;->u(Landroid/view/View;I)I
...
.method public t(Landroid/view/View;I)I
    ...
    invoke-virtual/range {v4 .. v9}, Landroidx/recyclerview/widget/r;->s(IIIII)I
...
.method protected w(I)I
    ...
    invoke-virtual {p0, p1}, Landroidx/recyclerview/widget/r;->x(I)I
...
.method protected x(I)I
    ...
    invoke-direct {p0}, Landroidx/recyclerview/widget/r;->A()F
