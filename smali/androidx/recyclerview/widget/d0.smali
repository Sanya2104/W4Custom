...
# instance fields
.field final a:Landroidx/recyclerview/widget/d0$b;

.field b:Landroidx/recyclerview/widget/d0$a;


# direct methods
.method constructor <init>(Landroidx/recyclerview/widget/d0$b;)V
    .locals 0
...
.method a(IIII)Landroid/view/View;
    ...
    invoke-interface {v0}, Landroidx/recyclerview/widget/d0$b;->c()I
    ...
    invoke-interface {v4, p1}, Landroidx/recyclerview/widget/d0$b;->a(I)Landroid/view/View;
    ...
    invoke-virtual {v7, v0, v1, v5, v6}, Landroidx/recyclerview/widget/d0$a;->e(IIII)V

    if-eqz p3, :cond_1

    iget-object v5, p0, Landroidx/recyclerview/widget/d0;->b:Landroidx/recyclerview/widget/d0$a;

    invoke-virtual {v5}, Landroidx/recyclerview/widget/d0$a;->d()V

    iget-object v5, p0, Landroidx/recyclerview/widget/d0;->b:Landroidx/recyclerview/widget/d0$a;

    invoke-virtual {v5, p3}, Landroidx/recyclerview/widget/d0$a;->a(I)V
    ...
    invoke-virtual {v5, p4}, Landroidx/recyclerview/widget/d0$a;->a(I)V
...
.method b(Landroid/view/View;I)Z
    ...
    invoke-interface {v2}, Landroidx/recyclerview/widget/d0$b;->d()I
    ...
    invoke-virtual {v0, v1, v2, v3, p1}, Landroidx/recyclerview/widget/d0$a;->e(IIII)V

    if-eqz p2, :cond_0

    iget-object p1, p0, Landroidx/recyclerview/widget/d0;->b:Landroidx/recyclerview/widget/d0$a;

    invoke-virtual {p1}, Landroidx/recyclerview/widget/d0$a;->d()V

    iget-object p1, p0, Landroidx/recyclerview/widget/d0;->b:Landroidx/recyclerview/widget/d0$a;

    invoke-virtual {p1, p2}, Landroidx/recyclerview/widget/d0$a;->a(I)V
