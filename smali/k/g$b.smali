...
.method private i(Landroid/view/MenuItem;)V
    ...
    :cond_8
    :goto_3
    iget-object v0, p0, Lk/g$b;->A:Ln0/b;

    if-eqz v0, :cond_9

    invoke-static {p1, v0}, Ln0/p;->a(Landroid/view/MenuItem;Ln0/b;)Landroid/view/MenuItem;

    :cond_9
    iget-object v0, p0, Lk/g$b;->B:Ljava/lang/CharSequence;

    invoke-static {p1, v0}, Ln0/p;->c(Landroid/view/MenuItem;Ljava/lang/CharSequence;)V

    iget-object v0, p0, Lk/g$b;->C:Ljava/lang/CharSequence;

    invoke-static {p1, v0}, Ln0/p;->g(Landroid/view/MenuItem;Ljava/lang/CharSequence;)V

    iget-char v0, p0, Lk/g$b;->n:C

    iget v1, p0, Lk/g$b;->o:I

    invoke-static {p1, v0, v1}, Ln0/p;->b(Landroid/view/MenuItem;CI)V

    iget-char v0, p0, Lk/g$b;->p:C

    iget v1, p0, Lk/g$b;->q:I

    invoke-static {p1, v0, v1}, Ln0/p;->f(Landroid/view/MenuItem;CI)V

    iget-object v0, p0, Lk/g$b;->E:Landroid/graphics/PorterDuff$Mode;

    if-eqz v0, :cond_a

    invoke-static {p1, v0}, Ln0/p;->e(Landroid/view/MenuItem;Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p1, v0}, Ln0/p;->d(Landroid/view/MenuItem;Landroid/content/res/ColorStateList;)V
...
.method public g(Landroid/util/AttributeSet;)V
    ...
    invoke-static {v0, p1, v1}, Landroidx/appcompat/widget/j1;->u(Landroid/content/Context;Landroid/util/AttributeSet;[I)Landroidx/appcompat/widget/j1;
    ...
    invoke-virtual {p1, v0, v2}, Landroidx/appcompat/widget/j1;->k(II)I
    ...
    invoke-virtual {p1, v2, v3}, Landroidx/appcompat/widget/j1;->k(II)I
    ...
    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/j1;->p(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/j1;->o(I)Ljava/lang/String;
    ...
    invoke-virtual {p1, v0, v1}, Landroidx/appcompat/widget/j1;->a(IZ)Z
    ...
    invoke-virtual {p1, v0, v2}, Landroidx/appcompat/widget/j1;->a(IZ)Z
    ...
    iput-object v0, p0, Lk/g$b;->A:Ln0/b;
    ...
    :cond_3
    iput-object v4, p0, Lk/g$b;->A:Ln0/b;
    ...
    invoke-static {v0, v2}, Landroidx/appcompat/widget/n0;->d(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/j1;->c(I)Landroid/content/res/ColorStateList;
