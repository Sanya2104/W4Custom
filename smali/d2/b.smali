...
.method private declared-synchronized R(Ld2/b$c;Z)V
    .locals 9
    ...
    :cond_3
    invoke-static {p1}, Ld2/b;->W(Ljava/io/File;)V
    ...
    invoke-static {p1}, Ld2/b;->d0(Ljava/io/Writer;)V
...
.method private declared-synchronized b0(Ljava/lang/String;J)Ld2/b$c;
    .locals 5

    monitor-enter p0

    :try_start_0
    invoke-direct {p0}, Ld2/b;->y()V
...
.method static synthetic c(Ld2/b;)V
    ...
    invoke-direct {p0}, Ld2/b;->z0()V

    return-void
.end method

.method private static d0(Ljava/io/Writer;)V
    .locals 2
    .annotation build Landroid/annotation/TargetApi;
        value = 0x1a
    .end annotation
...
.method public static m0(Ljava/io/File;IIJ)Ld2/b;
    .locals 9
    ...
    invoke-static {v0, v1, v2}, Ld2/b;->y0(Ljava/io/File;Ljava/io/File;Z)V
    ...
    :try_start_0
    invoke-direct {v0}, Ld2/b;->u0()V

    invoke-direct {v0}, Ld2/b;->r0()V
    :try_end_0
...
.method static synthetic n(Ld2/b;)Ljava/io/File;
    .locals 0
...
.method static synthetic p(Ld2/b;Ld2/b$c;Z)V
    .locals 0

    invoke-direct {p0, p1, p2}, Ld2/b;->R(Ld2/b$c;Z)V
...
.method private r0()V
    ...
    invoke-static {v0}, Ld2/b;->W(Ljava/io/File;)V
    ...
    invoke-static {v2}, Ld2/b;->W(Ljava/io/File;)V
...
.method static synthetic u(Ld2/b;)Z
    .locals 0
...
.method private u0()V
    ...
    :try_start_0
    invoke-virtual {v1}, Ld2/c;->u()Ljava/lang/String;
    ...
    invoke-direct {p0, v2}, Ld2/b;->v0(Ljava/lang/String;)V
    :try_end_1
    ...
    invoke-virtual {v1}, Ld2/c;->p()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-direct {p0}, Ld2/b;->w0()V
...
.method static synthetic v(Ld2/b;)V
    .locals 0
...
.method static synthetic w(Ld2/b;I)I
    .locals 0
...
.method private declared-synchronized w0()V
    ...
    invoke-static {v0}, Ld2/b;->F(Ljava/io/Writer;)V
    ...
    invoke-static {v0, v2, v1}, Ld2/b;->y0(Ljava/io/File;Ljava/io/File;Z)V
    ...
    invoke-static {v0, v2, v3}, Ld2/b;->y0(Ljava/io/File;Ljava/io/File;Z)V
...
.method private z0()V
    ...
    invoke-virtual {p0, v0}, Ld2/b;->x0(Ljava/lang/String;)Z
...
.method public X(Ljava/lang/String;)Ld2/b$c;
    .locals 2

    const-wide/16 v0, -0x1

    invoke-direct {p0, p1, v0, v1}, Ld2/b;->b0(Ljava/lang/String;J)Ld2/b$c;
...
.method public declared-synchronized e0(Ljava/lang/String;)Ld2/b$e;
    .locals 9
