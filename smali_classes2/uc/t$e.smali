...
.method constructor <init>(Luc/t;Landroidx/room/f0;)V
    ...
    iput-object p1, p0, Luc/t$e;->d:Luc/t;
...
.method public d()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR ABORT `task` SET `id` = ?,`job_id` = ?,`task_type_id` = ?,`status` = ?,`current_state_id` = ?,`priority` = ?,`created_at` = ?,`accepted_by` = ?,`accepted_at` = ?,`finalized_by` = ?,`finalized_at` = ?,`scheduled_start` = ?,`scheduled_end` = ?,`due_date` = ?,`is_task_editable` = ?,`actions` = ?,`next_action` = ?,`map_data_blob` = ?,`create_form_variant_id` = ? WHERE `id` = ?"
...
.method public bridge synthetic g(Lr1/f;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Luc/t$e;->i(Lr1/f;Lnet/gdi/w4/data/model/ApiTask;)V

    return-void
.end method

.method public i(Lr1/f;Lnet/gdi/w4/data/model/ApiTask;)V
    .locals 4
