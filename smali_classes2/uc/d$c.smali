...
.method constructor <init>(Luc/d;Landroidx/room/f0;)V
    ...
    iput-object p1, p0, Luc/d$c;->d:Luc/d;
...
.method public d()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR ABORT `comment` SET `id` = ?,`web_parts_values_id` = ?,`worker_id` = ?,`worker_name` = ?,`date_entered` = ?,`date_edited` = ?,`comment` = ?,`comment_type` = ?,`context_id` = ?,`waiting_for_upload` = ?,`waiting_for_delete` = ? WHERE `id` = ?"
...
.method public bridge synthetic g(Lr1/f;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Luc/d$c;->i(Lr1/f;Lnet/gdi/w4/data/model/ApiComment;)V

    return-void
.end method

.method public i(Lr1/f;Lnet/gdi/w4/data/model/ApiComment;)V
    .locals 4
