...
.method public constructor <init>(Landroidx/room/f0;)V
    ...
    iput-object p1, p0, Luc/r1;->a:Landroidx/room/f0;

    new-instance v0, Luc/r1$a;

    invoke-direct {v0, p0, p1}, Luc/r1$a;-><init>(Luc/r1;Landroidx/room/f0;)V

    iput-object v0, p0, Luc/r1;->b:Lo1/j;

    new-instance v0, Luc/r1$b;

    invoke-direct {v0, p0, p1}, Luc/r1$b;-><init>(Luc/r1;Landroidx/room/f0;)V

    iput-object v0, p0, Luc/r1;->c:Lo1/i;

    new-instance v0, Luc/r1$c;

    invoke-direct {v0, p0, p1}, Luc/r1$c;-><init>(Luc/r1;Landroidx/room/f0;)V

    iput-object v0, p0, Luc/r1;->d:Lo1/i;
...
# virtual methods
.method public a(Lvc/f;)J
    .locals 2

    iget-object v0, p0, Luc/r1;->a:Landroidx/room/f0;
    ...
    :try_start_0
    iget-object v0, p0, Luc/r1;->b:Lo1/j;

    invoke-virtual {v0, p1}, Lo1/j;->j(Ljava/lang/Object;)J

    move-result-wide v0

    iget-object p1, p0, Luc/r1;->a:Landroidx/room/f0;
...
.method public b(Lvc/f;)V
    ...
    :try_start_0
    invoke-static {p0, p1}, Luc/q1$a;->a(Luc/q1;Lvc/f;)V
...
.method public c(J)Ljava/util/List;
    ...
    const-string v0, "SELECT * FROM task_crew_member WHERE task_id = ?"
    ...
    const-string v1, "crew_member_id"
    ...
    invoke-direct {v7, v3, v4, v5, v6}, Lvc/f;-><init>(JJ)V
...
.method public d(Lvc/f;)I
    ...
    :try_start_0
    iget-object v0, p0, Luc/r1;->d:Lo1/i;
...
.method public e(Lvc/f;)V
    ...
    :try_start_0
    iget-object v0, p0, Luc/r1;->c:Lo1/i;
