...
.method constructor <init>(Luc/v1;Landroidx/room/f0;)V
    ...
    iput-object p1, p0, Luc/v1$b;->d:Luc/v1;
...
.method public d()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR ABORT `transition` SET `id` = ?,`task_id` = ?,`dev_name` = ?,`name` = ?,`enqueued` = ?,`validate_web_parts` = ?,`finalization_action_id` = ?,`finalization_action_name` = ? WHERE `id` = ?"
...
.method public bridge synthetic g(Lr1/f;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Luc/v1$b;->i(Lr1/f;Lnet/gdi/w4/data/model/Transition;)V

    return-void
.end method

.method public i(Lr1/f;Lnet/gdi/w4/data/model/Transition;)V
    .locals 4
    ...
    invoke-virtual {v0}, Lnet/gdi/w4/data/model/FinalizationAction;->getId()Ljava/lang/String;
    ...
    invoke-interface {p1, v2, v3}, Lr1/d;->f(ILjava/lang/String;)V

    :goto_2
    invoke-virtual {v0}, Lnet/gdi/w4/data/model/FinalizationAction;->getName()Ljava/lang/String;
