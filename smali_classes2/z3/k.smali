...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lz3/k;->b:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lz3/k;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static b(I)Ljava/lang/String;
    ...
    invoke-static {p0}, Lz3/b;->y(I)Ljava/lang/String;
...
.method public static e(Landroid/content/Context;)Z
    ...
    :try_start_0
    invoke-static {p0}, Lj4/e;->a(Landroid/content/Context;)Lj4/d;
    ...
    invoke-virtual {v0, v3, v4}, Lj4/d;->e(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;

    move-result-object v0

    invoke-static {p0}, Lz3/l;->a(Landroid/content/Context;)Lz3/l;

    if-eqz v0, :cond_0

    invoke-static {v0, v1}, Lz3/l;->e(Landroid/content/pm/PackageInfo;Z)Z

    move-result p0

    if-nez p0, :cond_0

    invoke-static {v0, v2}, Lz3/l;->e(Landroid/content/pm/PackageInfo;Z)Z

    move-result p0

    if-eqz p0, :cond_0

    sput-boolean v2, Lz3/k;->c:Z

    goto :goto_0

    :cond_0
    sput-boolean v1, Lz3/k;->c:Z
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :goto_0
    sput-boolean v2, Lz3/k;->d:Z
    ...
    :cond_1
    :goto_2
    sget-boolean p0, Lz3/k;->c:Z

    if-nez p0, :cond_3

    invoke-static {}, Lh4/h;->c()Z
...
.method public static f(Landroid/content/Context;I)I
    ...
    sget-object v1, Lz3/k;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_0
    invoke-static {p0}, Lc4/t0;->a(Landroid/content/Context;)I
    ...
    :cond_3
    :goto_1
    invoke-static {p0}, Lh4/h;->f(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Lh4/h;->h(Landroid/content/Context;)Z
    ...
    invoke-static {v9, v3}, Lz3/l;->e(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {v8, v3}, Lz3/l;->e(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {p0}, Lh4/p;->a(I)I

    move-result p0

    invoke-static {p1}, Lh4/p;->a(I)I
...
.method public static g(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1}, Lz3/k;->k(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static j(Landroid/content/Context;ILjava/lang/String;)Z
    ...
    invoke-static {p0, p1, p2}, Lh4/n;->b(Landroid/content/Context;ILjava/lang/String;)Z
...
.method static k(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {p0}, Lz3/k;->h(Landroid/content/Context;)Z
