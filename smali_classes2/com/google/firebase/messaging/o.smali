...
.field private static d:Lcom/google/firebase/messaging/d1;
...
.method private static a(Landroid/content/Context;Landroid/content/Intent;)Ly4/j;
    .locals 2
    ...
    invoke-virtual {p0, p1}, Lcom/google/firebase/messaging/d1;->c(Landroid/content/Intent;)Ly4/j;

    move-result-object p0

    sget-object p1, Lcom/google/firebase/messaging/k;->a:Ljava/util/concurrent/Executor;

    sget-object v0, Lcom/google/firebase/messaging/l;->a:Ly4/b;

    invoke-virtual {p0, p1, v0}, Ly4/j;->k(Ljava/util/concurrent/Executor;Ly4/b;)Ly4/j;
...
.method private static b(Landroid/content/Context;Ljava/lang/String;)Lcom/google/firebase/messaging/d1;
    ...
    :try_start_0
    sget-object v1, Lcom/google/firebase/messaging/o;->d:Lcom/google/firebase/messaging/d1;
    ...
    sput-object v1, Lcom/google/firebase/messaging/o;->d:Lcom/google/firebase/messaging/d1;

    :cond_0
    sget-object p0, Lcom/google/firebase/messaging/o;->d:Lcom/google/firebase/messaging/d1;
...
.method static final synthetic c(Ly4/j;)Ljava/lang/Integer;
    .locals 0
...
.method static final synthetic e(Ly4/j;)Ljava/lang/Integer;
    .locals 0
...
.method static final synthetic f(Landroid/content/Context;Landroid/content/Intent;Ly4/j;)Ly4/j;
    .locals 2
    ...
    :cond_0
    invoke-static {p0, p1}, Lcom/google/firebase/messaging/o;->a(Landroid/content/Context;Landroid/content/Intent;)Ly4/j;

    move-result-object p0

    sget-object p1, Lcom/google/firebase/messaging/m;->a:Ljava/util/concurrent/Executor;

    sget-object p2, Lcom/google/firebase/messaging/n;->a:Ly4/b;

    invoke-virtual {p0, p1, p2}, Ly4/j;->k(Ljava/util/concurrent/Executor;Ly4/b;)Ly4/j;
...
# virtual methods
.method public g(Landroid/content/Intent;)Ly4/j;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, v0, p1}, Lcom/google/firebase/messaging/o;->h(Landroid/content/Context;Landroid/content/Intent;)Ly4/j;
...
.method public h(Landroid/content/Context;Landroid/content/Intent;)Ly4/j;
    .locals 3
    ...
    invoke-static {p1, p2}, Lcom/google/firebase/messaging/o;->a(Landroid/content/Context;Landroid/content/Intent;)Ly4/j;
