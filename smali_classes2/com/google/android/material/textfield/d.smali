...
.method private A(FFFI)Lr5/g;
    .locals 1

    invoke-static {}, Lr5/k;->a()Lr5/k$b;

    move-result-object v0

    invoke-virtual {v0, p1}, Lr5/k$b;->A(F)Lr5/k$b;

    move-result-object v0

    invoke-virtual {v0, p1}, Lr5/k$b;->E(F)Lr5/k$b;

    move-result-object p1

    invoke-virtual {p1, p2}, Lr5/k$b;->s(F)Lr5/k$b;

    move-result-object p1

    invoke-virtual {p1, p2}, Lr5/k$b;->w(F)Lr5/k$b;
    ...
    invoke-static {p2, p3}, Lr5/g;->m(Landroid/content/Context;F)Lr5/g;

    move-result-object p2

    invoke-virtual {p2, p1}, Lr5/g;->setShapeAppearanceModel(Lr5/k;)V

    const/4 p1, 0x0

    invoke-virtual {p2, p1, p4, p1, p4}, Lr5/g;->Z(IIII)V
...
.method private F(Landroid/widget/AutoCompleteTextView;)V
    ...
    iget-object v0, p0, Lcom/google/android/material/textfield/d;->m:Lr5/g;
...
.method private v(Landroid/widget/AutoCompleteTextView;)V
    ...
    invoke-virtual {v1}, Lcom/google/android/material/textfield/TextInputLayout;->getBoxBackground()Lr5/g;

    move-result-object v1

    sget v2, Lz4/b;->i:I

    invoke-static {p1, v2}, Lg5/a;->d(Landroid/view/View;I)I
    ...
    invoke-direct {p0, p1, v2, v4, v1}, Lcom/google/android/material/textfield/d;->x(Landroid/widget/AutoCompleteTextView;I[[ILr5/g;)V
    ...
    invoke-direct {p0, p1, v2, v4, v1}, Lcom/google/android/material/textfield/d;->w(Landroid/widget/AutoCompleteTextView;I[[ILr5/g;)V
...
.method private w(Landroid/widget/AutoCompleteTextView;I[[ILr5/g;)V
    .locals 5
    ...
    invoke-static {p2, v0, v1}, Lg5/a;->h(IIF)I
    ...
    invoke-static {p1, p3}, Ln0/f0;->q0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p4}, Lr5/g;->C()Lr5/k;

    move-result-object v4

    invoke-direct {v0, v4}, Lr5/g;-><init>(Lr5/k;)V

    new-instance v4, Landroid/content/res/ColorStateList;

    invoke-direct {v4, p3, v2}, Landroid/content/res/ColorStateList;-><init>([[I[I)V

    invoke-virtual {v0, v4}, Lr5/g;->X(Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {p1}, Ln0/f0;->F(Landroid/view/View;)I
    ...
    invoke-static {p1}, Ln0/f0;->E(Landroid/view/View;)I
    ...
    invoke-static {p1, p2}, Ln0/f0;->q0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V

    invoke-static {p1, p3, p4, v0, v1}, Ln0/f0;->z0(Landroid/view/View;IIII)V

    :goto_0
    return-void
.end method

.method private x(Landroid/widget/AutoCompleteTextView;I[[ILr5/g;)V
    .locals 7

    sget v0, Lz4/b;->m:I

    invoke-static {p1, v0}, Lg5/a;->d(Landroid/view/View;I)I
    ...
    invoke-direct {v1, v2}, Lr5/g;-><init>(Lr5/k;)V

    const v2, 0x3dcccccd    # 0.1f

    invoke-static {p2, v0, v2}, Lg5/a;->h(IIF)I
    ...
    invoke-virtual {v1, v6}, Lr5/g;->X(Landroid/content/res/ColorStateList;)V

    sget-boolean v3, Lcom/google/android/material/textfield/d;->q:Z

    if-eqz v3, :cond_0

    invoke-virtual {v1, v0}, Lr5/g;->setTint(I)V
    ...
    invoke-direct {p3, v0}, Lr5/g;-><init>(Lr5/k;)V

    const/4 v0, -0x1

    invoke-virtual {p3, v0}, Lr5/g;->setTint(I)V
...
.method private varargs z(I[F)Landroid/animation/ValueAnimator;
    ...
    sget-object v0, La5/a;->a:Landroid/animation/TimeInterpolator;
...
.method a()V
    ...
    invoke-direct {p0, v0, v0, v1, v2}, Lcom/google/android/material/textfield/d;->A(FFFI)Lr5/g;

    move-result-object v3

    const/4 v4, 0x0

    invoke-direct {p0, v4, v0, v1, v2}, Lcom/google/android/material/textfield/d;->A(FFFI)Lr5/g;

    move-result-object v0

    iput-object v3, p0, Lcom/google/android/material/textfield/d;->m:Lr5/g;
    ...
    invoke-static {v2, v0}, Lg/a;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
